...
#
#    Given Project Admin is in 'Edit Test case ' Page
#    When changes  some data in the text boxes
#    And Clicks the 'Reset' button
#    Then the edited data is reset by the old data
#
#
#  Scenario : Project admin can cancel editing the testcases
#
#    Given Project Admin is in 'Edit test case ' Page
